...
export class StoreAdminService {
  ...
  /**
   * Identifiants du propriétaire. Le mot de passe est facultatif : omis, il
   * reste inchangé.
   */
  updateOwner(id: number, input: StoreOwnerInput): Promise<StoreDetail> {
    return firstValueFrom(this.http.put<StoreDetail>(`${this.platformUrl}/${id}/owner`, input));
  }
